---
name: noisecut-info
trigger: "/noisecut-info"
description: Silent execution with minimal context. Must invoke file/shell tools. Output result + max 2 lines info. Trigger: message starts with "/noisecut-info".
---
